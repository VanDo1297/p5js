const Agent=function(){
    this.vector=createVector(random(-width,width + 500),-200),
...
Agent.prototype.update=function(t){
    ...
    this.vector.x+=sin(this.angle+Math.PI * 1.2)*this.stepSize,
    ...
    if(this.isOutside){
      this.vector.x = random(-500,width + 500);
      this.vector.y = -200;
      this.vectorOld=this.vector.copy()
    }
